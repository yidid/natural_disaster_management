...
const AdminRespondersCRUD = ()=>{
    ...
    const [currentResponders, setCurrentResponders] = useState(null);
    ...
    const findByTitle = () => {
      ResponderServices.findByTitle(searchTitle)
        .then(response => {
          setResponders(response.data);
          console.log(response.data);
        })
                          ...
                          <tr>
                              ...
                              <td class="p-2 whitespace-nowrap">
                                  ...
                                  <div class="w-10 h-10 flex-shrink-0 mr-2 sm:mr-3"><img class="rounded-full" src="https://raw.githubusercontent.com/cruip/vuejs-admin-dashboard-template/main/src/images/user-36-05.jpg" width="40" height="40" alt="Alex Shatov"></img></div>
                                      <div class="font-medium text-gray-800">{responder.name}</div>
                                  </div>
                              </td>
                              <td class="p-2 whitespace-nowrap">
                                  <div class="text-left font-medium text-green-500">{responder.department}</div>
                              </td>
                              <td class="p-2 whitespace-nowrap">
                                  <div class="text-left">{responder.phone}</div>
                              </td>
