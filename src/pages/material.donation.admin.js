...
const MaterialDonationsAdmin =()=>{
      ...
      MaterialService.findByTitle(searchTitle)
        ...
        <div>
          ...
          <div class="block rounded-lg  z-1 bg-gray-50 ml-64 mb-96 p-24 m- dark:bg-grey-100">
           ...
           <a href="/donation" className="flex flex-row font-medium text-blue-600 dark:text-blue-500 hover:underline mb-10">
               Cash donation
 ...
 <div className="flex items-baseline text-gray-900 dark:text-white">
     ...
     <span className="text-5xl font-extrabold text-slate-800 tracking-tight">{material.amount}</span>
 ...
 <ul className="space-y-5 my-7">
     ...
     <svg className="flex-shrink-0 w-4 h-4 text-blue-600 dark:text-blue-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
         ...
         <span className="text-base font-normal leading-tight text-slate-800"> {material.bank} {material.account}</span>
     </li>
     ...
     <span className="text-base font-normal leading-tight text-slate-800"> Full Name</span>
        ...
        <span className="text-base font-normal leading-tight text-slate-800 "> {material.name}</span>
     </li>
     <li className="flex space-x-3">
...
<path fill-rule="evenodd" d="M1.5 4.5a3 3 0 013-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 01-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 006.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 011.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 01-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5z" clip-rule="evenodd" />
         ...
         <span className="text-base font-normal leading-tight text-slate-800 ">{material.phone}</span>
     </li>
     <li className="flex space-x-3 ">
         ...
         <span className="text-base font-normal leading-tight text-slate-800">{material.description}</span>
     </li>
...
export default MaterialDonationsAdmin